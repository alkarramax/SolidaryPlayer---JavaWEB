...
public class editarCampanha extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if(nome != null && local != null && dataInicio != null && dataTermino != null && descricao != null && imagem != null) {
                String query = "update campanha set nome=?, local=?, dataInicio=?, dataTermino=?, descricao=?, imagem=? where id='"+id+"'";
